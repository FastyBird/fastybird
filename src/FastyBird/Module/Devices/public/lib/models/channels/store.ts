...
import { useChannelControls, useChannelProperties, useDevices } from '@/lib/models';
import { IChannelControlResponseModel, IChannelPropertyResponseModel, IPlainRelation } from '@/lib/models/types';
