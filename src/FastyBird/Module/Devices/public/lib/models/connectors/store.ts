...
import { useConnectorControls, useConnectorProperties, useDevices } from '@/lib/models';
import { IConnectorProperty, IConnectorPropertyResponseModel, IConnectorControlResponseModel, IPlainRelation } from '@/lib/models/types';
