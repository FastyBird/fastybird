...
import { useChannels, useDevices } from '@/lib/models'
import { IChannel } from '@/lib/models/types'
...
export const useChannelControls = defineStore<string, IChannelControlsState, IChannelControlsGetters, IChannelControlsActions>('channels_module_channels_controls', {
  ...
  actions: {
    ...
    async get(payload: IChannelControlsGetActionPayload): Promise<boolean> {
      ...
      try {
        ...
        throw new ApiError(
          'devices-module.channel-controls.get.failed',
          e,
    ...
    async add(payload: IChannelControlsAddActionPayload): Promise<IChannelControl> {
      ...
      if (newControl.draft) {
        ...
        try {
          ...
          throw new ApiError(
            'devices-module.channel-controls.create.failed',
            e,
    ...
    async save(payload: IChannelControlsSaveActionPayload): Promise<IChannelControl> {
      ...
      try {
        ...
        throw new ApiError(
          'devices-module.channel-controls.save.failed',
          e,
