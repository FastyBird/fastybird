export { default as PropertySettingsProperty } from './property-settings-property.vue';
export { default as PropertySettingsPropertyAddModal } from './property-settings-property-add-modal.vue';
