...
import { useFlashMessage } from '@/lib/composables'
import {
...
const { value: numberOfDecimalsField, errorMessage: numberOfDecimalsError, setValue: setNumberOfDecimals } = useField<number | null>('numberOfDecimals')
    ...
    if (val) {
      ...
      if (validationResult.valid) {
        ...
        try {
          ...
          const errorMessage = props.property.draft ? t('messages.propertyNotCreated', { property: nameField.value }) : t('messages.propertyNotEdited', { property: nameField.value })
