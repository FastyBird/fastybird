export { default as ChannelSettingsChannelRemove } from './channel-settings-channel-remove.vue'
export { default as ChannelSettingsChannelRename } from './channel-settings-channel-rename.vue'
export { default as ChannelSettingsChannelReset } from './channel-settings-channel-reset.vue'
