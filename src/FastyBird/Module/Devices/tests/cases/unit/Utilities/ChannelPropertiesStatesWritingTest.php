		...
		return [
			...
			'write_01' => [
				new MetadataDocuments\DevicesModule\ChannelDynamicProperty(
					$property01,
					MetadataTypes\PropertyType::get(MetadataTypes\PropertyType::TYPE_DYNAMIC),
					$channel01,
					MetadataTypes\PropertyCategory::get(MetadataTypes\PropertyCategory::CATEGORY_GENERIC),
					'test-property-01',
					'Testing Property 01',
			...
			'write_05' => [
				new MetadataDocuments\DevicesModule\ChannelMappedProperty(
					$child01,
					MetadataTypes\PropertyType::get(MetadataTypes\PropertyType::TYPE_MAPPED),
					$channel02,
					$property01,
					MetadataTypes\PropertyCategory::get(MetadataTypes\PropertyCategory::CATEGORY_GENERIC),
					'child-property-05',
