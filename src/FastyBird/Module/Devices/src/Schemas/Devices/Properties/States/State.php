...
final class State extends JsonApiSchemas\JsonApi
{
	 ...
	 */
	public const SCHEMA_TYPE = MetadataTypes\ModuleSource::DEVICES . '/property/device/' . MetadataTypes\PropertyType::DYNAMIC . '/state';
	...
	{
		return States\DeviceProperty::class;
	}
