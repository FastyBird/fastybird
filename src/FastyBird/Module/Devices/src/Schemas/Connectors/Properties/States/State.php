...
use FastyBird\Module\Devices\Entities\Connectors\Properties\Dynamic as T;
...
final class State extends JsonApiSchemas\JsonApi
{
	 ...
	 */
	public const SCHEMA_TYPE = MetadataTypes\Sources\Module::DEVICES . '/property/connector/' . MetadataTypes\PropertyType::DYNAMIC . '/state';
	...
	{
		return MetadataDocuments\DevicesModule\ConnectorPropertyState::class;
	}
