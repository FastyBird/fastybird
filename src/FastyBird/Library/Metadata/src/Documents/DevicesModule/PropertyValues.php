...
final class PropertyValues implements Documents\Document
{
	...
	public function __construct(
		...
		private readonly bool|float|int|string|DateTimeInterface|Types\Payloads\Button|Types\Payloads\Switcher|Types\Payloads\Cover|null $actualValue,
		#[ObjectMapper\Rules\AnyOf([
			new ObjectMapper\Rules\DateTimeValue(format: DateTimeInterface::ATOM),
			new ApplicationObjectMapper\Rules\ConsistenceEnumValue(class: Types\Payloads\Button::class),
			new ApplicationObjectMapper\Rules\ConsistenceEnumValue(class: Types\Payloads\Switcher::class),
		...
		private readonly bool|float|int|string|DateTimeInterface|Types\Payloads\Button|Types\Payloads\Switcher|Types\Payloads\Cover|null $expectedValue,
	)
	{
	}
