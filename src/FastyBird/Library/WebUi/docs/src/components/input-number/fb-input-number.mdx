...
<Canvas withToolbar={true} of={InputNumberStories.BasicUsage} />
...
<Canvas withToolbar={true} of={InputNumberStories.Disabled} />

## Steps

You can define incremental steps by adding the `step` property and setting the desired step value.

<Canvas withToolbar={true} of={InputNumberStories.Steps} />
...
<Canvas withToolbar={true} of={InputNumberStories.StrictlyStep} />
