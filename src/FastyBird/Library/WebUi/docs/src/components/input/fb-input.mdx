...
<Canvas withToolbar={true} of={InputStories.BasicUsage} />
...
<Canvas withToolbar={true} of={InputStories.Disabled} />
...
<Canvas withToolbar={true} of={InputStories.Clearable} />
...
<Canvas withToolbar={true} of={InputStories.Formatter} />
...
<Canvas withToolbar={true} of={InputStories.Password} />
...
<Canvas withToolbar={true} of={InputStories.WithIcon} />
...
<Canvas withToolbar={true} of={InputStories.Textarea} />
...
<Canvas withToolbar={true} of={InputStories.AutosizeTextarea} />

## Mixed Input

You can use slots to distribute elements that you want to prepend or append to the Input component.

<Canvas withToolbar={true} of={InputStories.Mixed} />
...
<Canvas withToolbar={true} of={InputStories.Sizes} />
...
<Canvas withToolbar={true} of={InputStories.LimitLength} />
