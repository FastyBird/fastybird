...
<Canvas withToolbar={true} of={CheckboxStories.BasicUsage} />

## Disabled

To disable a Checkbox, simply add the `disabled` property.

<Canvas withToolbar={true} of={CheckboxStories.Disabled} />
...
<Canvas withToolbar={true} of={CheckboxStories.CheckboxGroup} />

## Indeterminate

The `indeterminate` property enables you to achieve a "check all" effect.

<Canvas withToolbar={true} of={CheckboxStories.Indeterminate} />

## Minimum & Maximum Items Checked

The `min` and `max` properties can be used to restrict the number of checked items.

<Canvas withToolbar={true} of={CheckboxStories.MinMax} />
...
<Canvas withToolbar={true} of={CheckboxStories.Button} />

## With Borders

The `border` property adds a border to Checkboxes.

<Canvas withToolbar={true} of={CheckboxStories.Bordered} />
