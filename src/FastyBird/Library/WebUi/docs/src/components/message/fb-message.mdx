...
<Canvas withToolbar={true} of={MessageStories.BasicUsage} />
...
<Canvas withToolbar={true} of={MessageStories.Types} />
...
<Canvas withToolbar={true} of={MessageStories.Closable} />

## Centered Text

Use the `center` property to center the text.

<Canvas withToolbar={true} of={MessageStories.CenteredText} />
...
<Canvas withToolbar={true} of={MessageStories.HtmlContent} />
...
<Canvas withToolbar={true} of={MessageStories.Grouping} />
