		...
		Tests\Tools\JsonAssert::assertFixtureMatch(
			...
			static function (string $expectation) use ($actual): string {
				...
				if (
					...
					&& isset($actual['data']['relationships']['properties']['data'])
					&& is_array($actual['data']['relationships']['properties']['data'])
					&& isset($actual['data']['relationships']['properties']['data'][3])
					&& is_array($actual['data']['relationships']['properties']['data'][3])
					&& isset($actual['data']['relationships']['properties']['data'][3]['id'])
				) {
					$expectation = str_replace(
						'__PROPERTY_4_PLACEHOLDER__',
						strval($actual['data']['relationships']['properties']['data'][3]['id']),
						$expectation,
					);
				}
				...
				if (
					...
					&& isset($actual['data']['relationships']['channels']['data'])
					&& is_array($actual['data']['relationships']['channels']['data'])
					&& isset($actual['data']['relationships']['channels']['data'][1])
					&& is_array($actual['data']['relationships']['channels']['data'][1])
					&& isset($actual['data']['relationships']['channels']['data'][1]['id'])
				) {
					$expectation = str_replace(
						'__CHANNEL_2_PLACEHOLDER__',
						strval($actual['data']['relationships']['channels']['data'][1]['id']),
						$expectation,
					);
				}
				...
				if (
					...
					&& isset($actual['data']['relationships']['channels']['data'])
					&& is_array($actual['data']['relationships']['channels']['data'])
					&& isset($actual['data']['relationships']['channels']['data'][2])
					&& is_array($actual['data']['relationships']['channels']['data'][2])
					&& isset($actual['data']['relationships']['channels']['data'][2]['id'])
				) {
					$expectation = str_replace(
						'__CHANNEL_3_PLACEHOLDER__',
						strval($actual['data']['relationships']['channels']['data'][2]['id']),
						$expectation,
					);
				}
				...
				if (
					...
					&& isset($actual['data']['relationships']['channels']['data'][0])
					&& is_array($actual['data']['relationships']['channels']['data'][0])
					&& isset($actual['data']['relationships']['channels']['data'][0]['type'])
				) {
					$expectation = str_replace(
						'__CHANNEL_1_TYPE_PLACEHOLDER__',
						strval($actual['data']['relationships']['channels']['data'][0]['type']),
						$expectation,
					);
				}
				...
				if (
					...
					&& isset($actual['data']['relationships']['channels']['data'][1])
					&& is_array($actual['data']['relationships']['channels']['data'][1])
					&& isset($actual['data']['relationships']['channels']['data'][1]['type'])
				) {
					$expectation = str_replace(
						'__CHANNEL_2_TYPE_PLACEHOLDER__',
						strval($actual['data']['relationships']['channels']['data'][1]['type']),
						$expectation,
					);
				}
				...
				if (
					...
					&& isset($actual['data']['relationships']['channels']['data'][2])
					&& is_array($actual['data']['relationships']['channels']['data'][2])
					&& isset($actual['data']['relationships']['channels']['data'][2]['type'])
				) {
					$expectation = str_replace(
						'__CHANNEL_3_TYPE_PLACEHOLDER__',
						strval($actual['data']['relationships']['channels']['data'][2]['type']),
						$expectation,
					);
				}
