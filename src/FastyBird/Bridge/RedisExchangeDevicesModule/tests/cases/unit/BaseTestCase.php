...
namespace FastyBird\Bridge\RedisExchangeDevicesModule\Tests\Cases\Unit;

use DateTimeImmutable;
use FastyBird\Bridge\RedisExchangeDevicesModule;
...
abstract class BaseTestCase extends TestCase
{
	...
	protected function createContainer(string|null $additionalConfig = null): Nette\DI\Container
	{
		...
		RedisExchangeDevicesModule\DI\RedisExchangeDevicesModuleExtension::register($config);
