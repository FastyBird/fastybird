...
namespace FastyBird\Bridge\VirtualThermostatAddonHomeKitConnector\Tests\Cases\Unit;

use Doctrine\DBAL;
use Doctrine\ORM;
use Error;
use FastyBird\Bridge\VirtualThermostatAddonHomeKitConnector\DI;
...
abstract class DbTestCase extends TestCase
{
	...
	private function createContainer(): Nette\DI\Container
	{
		...
		DI\VirtualThermostatAddonHomeKitConnectorExtension::register($config);
