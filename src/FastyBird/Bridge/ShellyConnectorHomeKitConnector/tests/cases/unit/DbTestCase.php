...
namespace FastyBird\Bridge\ShellyConnectorHomeKitConnector\Tests\Cases\Unit;

use Doctrine\DBAL;
use Doctrine\ORM;
use Error;
use FastyBird\Bridge\ShellyConnectorHomeKitConnector\DI;
...
abstract class DbTestCase extends TestCase
{
	...
	private function createContainer(): Nette\DI\Container
	{
		...
		DI\ShellyConnectorHomeKitConnectorExtension::register($config);
