...
namespace FastyBird\Bridge\RedisExchangeWsExchange\Tests\Cases\Unit;

use DateTimeImmutable;
use FastyBird\Bridge\RedisExchangeWsExchange;
...
abstract class BaseTestCase extends TestCase
{
	...
	protected function createContainer(string|null $additionalConfig = null): Nette\DI\Container
	{
		...
		RedisExchangeWsExchange\DI\RedisExchangeWsExchangeExtension::register($config);
