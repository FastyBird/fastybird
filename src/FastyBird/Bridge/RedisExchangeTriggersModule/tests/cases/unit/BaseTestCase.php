...
namespace FastyBird\Bridge\RedisExchangeTriggersModule\Tests\Cases\Unit;

use DateTimeImmutable;
use FastyBird\Bridge\RedisExchangeTriggersModule;
...
abstract class BaseTestCase extends TestCase
{
	...
	protected function createContainer(string|null $additionalConfig = null): Nette\DI\Container
	{
		...
		RedisExchangeTriggersModule\DI\RedisExchangeTriggersModuleExtension::register($config);
