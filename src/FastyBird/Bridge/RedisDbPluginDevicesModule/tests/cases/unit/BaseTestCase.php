...
namespace FastyBird\Bridge\RedisDbPluginDevicesModule\Tests\Cases\Unit;

use DateTimeImmutable;
use Error;
use FastyBird\Bridge\RedisDbPluginDevicesModule;
...
abstract class BaseTestCase extends TestCase
{
	...
	protected function createContainer(string|null $additionalConfig = null): Nette\DI\Container
	{
		...
		RedisDbPluginDevicesModule\DI\RedisDbPluginDevicesModuleExtension::register($config);
