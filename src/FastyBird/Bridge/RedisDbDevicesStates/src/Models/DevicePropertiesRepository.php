...
class DevicePropertiesRepository implements DevicesModels\States\IDevicePropertiesRepository
{
	...
	/** @var RedisDbModels\StatesRepository<States\DeviceProperty> */
	private RedisDbModels\StatesRepository $stateRepository;

	/**
	 * @phpstan-param RedisDbModels\StatesRepositoryFactory<States\DeviceProperty> $stateRepositoryFactory
	 *
