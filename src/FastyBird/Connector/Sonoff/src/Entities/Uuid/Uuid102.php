...
namespace FastyBird\Connector\Sonoff\Entities\Uuid;
 ...
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 */
final class Uuid102 implements Entity
{
	...
	public function __construct(
		...
		#[ObjectMapper\Rules\AnyOf([
			new ObjectMapper\Rules\IntValue(min: 1, max: 5, castNumericString: true),
			new ObjectMapper\Rules\NullValue(),
		])]
