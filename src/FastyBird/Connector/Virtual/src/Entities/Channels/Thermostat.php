...
class Thermostat extends Entities\VirtualChannel
{
	...
	/**
	 * Thermostat minimum allowed temperature to be shown in UI
	 *
	 * @throws DevicesExceptions\InvalidState
	 * @throws MetadataExceptions\InvalidArgument
	 * @throws MetadataExceptions\InvalidState
	...
	public function getAllowedMinimumTemp(): float
	{
		$property = $this->properties
			->filter(
			// phpcs:ignore SlevomatCodingStandard.Files.LineLength.LineTooLong
				static fn (DevicesEntities\Channels\Properties\Property $property): bool => $property->getIdentifier() === Types\ChannelPropertyIdentifier::MINIMUM_ALLOWED_TEMPERATURE
			)
			->first();
		...
		return Entities\Devices\Thermostat::MINIMUM_TEMPERATURE;
	}

	/**
	 * Thermostat maximum allowed temperature to be shown in UI
	 *
	 * @throws DevicesExceptions\InvalidState
	 * @throws MetadataExceptions\InvalidArgument
	 * @throws MetadataExceptions\InvalidState
	...
	public function getAllowedMaximumTemp(): float
	{
		$property = $this->properties
			->filter(
			// phpcs:ignore SlevomatCodingStandard.Files.LineLength.LineTooLong
				static fn (DevicesEntities\Channels\Properties\Property $property): bool => $property->getIdentifier() === Types\ChannelPropertyIdentifier::MAXIMUM_ALLOWED_TEMPERATURE
			)
			->first();
		...
		return Entities\Devices\Thermostat::MAXIMUM_TEMPERATURE;
	}
