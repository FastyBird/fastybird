 ...
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 */
final class Configuration extends VirtualSchemas\VirtualChannel
{

	/**
	 * Define entity schema type string
	 */
	public const SCHEMA_TYPE = MetadataTypes\AddonSource::VIRTUAL_THERMOSTAT . '/channel/' . Entities\Channels\Configuration::TYPE;
