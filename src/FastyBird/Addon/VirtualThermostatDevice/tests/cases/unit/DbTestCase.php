...
namespace FastyBird\Addon\VirtualThermostatDevice\Tests\Cases\Unit;

use DateTimeImmutable;
use Doctrine\DBAL;
use Doctrine\ORM;
use Error;
use FastyBird\Addon\VirtualThermostatDevice\DI;
...
abstract class DbTestCase extends TestCase
{
	...
	private function createContainer(): Nette\DI\Container
	{
		...
		DI\VirtualThermostatDeviceExtension::register($config);
